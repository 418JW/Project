    ...
    <div class="row">
        <form id="form1" runat="server">
            <div class="third one">
                ...
                <asp:Button ID="enterButton" runat="server" Text="Enter" OnClick="enterButton_Click" CssClass="btn firstbtn" />
                <asp:Button ID="filterButton" runat="server" OnClick="filterButton_Click" Text="Filter" CssClass="btn"/>
            
                <div class="row">
                    <asp:ListBox ID="resultsBox" runat="server" class="resultbox" >
             ...
             <div class="third two">
                    <asp:Panel ID="panel" runat="server" Visible="False" CssClass="row">
                        <div class="row">
                            ...
                            <asp:Button ID="addButton" runat="server" OnClick="addButton_Click"  Text="Add" CssClass="btn" />
                            <asp:Button ID="changeButton" runat="server" OnClick="changeButton_Click" Text="Change" CssClass="btn" />
                        </div>
            ...
            <div class="row third three">
                ...
                <div class = "row"> 
                    <asp:Button ID="exportButton" runat="server" Text="Export" OnClick="exportButton_Click" CssClass="btn right" />
                    <asp:Button ID="saveButton" runat="server"  Text="Save" OnClick="saveButton_Click" CssClass="btn right" />
                </div>
            </div>       
