<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nonadmin.aspx.cs" Inherits="Practice.Nonadmin" %>
...
<body style="height: 508px">
    <form id="form1" runat="server">
        ...
        <div style="z-index: 1; left: 707px; top: 38px; position: absolute; height: 302px; width: 300px">
            <asp:Image ID="imageBox" runat="server" style="z-index: 1; left: 0px; top: 4px; position: absolute; height: 292px; width: 298px" />
        </div>
